...
How-it-works section, a Security section, and a Self-host CTA, with navigation
and footer. Content SHALL be sourced from real product capabilities and SHALL
NOT claim capabilities the product does not have.

#### Scenario: Required sections present

- **WHEN** the landing page is rendered
- **THEN** Hero, Features, How-it-works, Security, and Self-host CTA sections are
  all present and reachable via in-page navigation
