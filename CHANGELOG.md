...
## [0.7.0](https://github.com/Xeonice/cloud-agent-platform/compare/v0.45.3...v0.7.0) (2026-07-23)
...
* **auth:** private-account identity layer — email+password, OTP, GitHub ([0bc4dbf](https://github.com/Xeonice/cloud-agent-platform/commit/0bc4dbf501b6b3720efa8d64509437e0b0c2d48e))
* **console:** add the forge-token help page ([868fb6c](https://github.com/Xeonice/cloud-agent-platform/commit/868fb6ce495279db8436bdc6f441353071db8d9f))
...
* **console:** render the session transcript page from real data ([171a66e](https://github.com/Xeonice/cloud-agent-platform/commit/171a66e296889fd02e393fa04f60adad85e25e55))
...
* **mail:** recipient-routed transport seam + Resend OTP delivery docs ([a245cc4](https://github.com/Xeonice/cloud-agent-platform/commit/a245cc48bbad5c2e213a8dd15386bbbf80011764))
...
* **release:** generate task-model attestation in CI and apply it through both upgrade seams ([55d2ebf](https://github.com/Xeonice/cloud-agent-platform/commit/55d2ebf64fbba67a4c2d7e5fc3b633330533cb53))
...
* **settings:** admin-configurable Resend SMTP in the console ([302b3b9](https://github.com/Xeonice/cloud-agent-platform/commit/302b3b96c58688ab23eecb14e7ad4685dedf0db8))
...
* **auth:** full-page post-login navigation + rotate session on password change ([0981782](https://github.com/Xeonice/cloud-agent-platform/commit/09817820d99775f381eef2b71670fa2bc41d84c1))
...
* **auth:** promote an existing ADMIN_EMAIL account to admin ([c342cdf](https://github.com/Xeonice/cloud-agent-platform/commit/c342cdf6136d1551b8d32b53bb9c4436611b8a26))
...
* on replay completion, before scrollToTop, do a resize nudge (resize(cols, rows+1) then resize(cols, rows)) that keeps cols unchanged (no wrap reflow, cast cursor-addressing preserved) but forces syncScrollArea. Measured live: vp.scrollHeight 581 -&gt; 4859, canScroll true. ([d2b8850](https://github.com/Xeonice/cloud-agent-platform/commit/d2b88504af90bf244c7b3b0a37b03dca4da5130b))
...
* **rate-limit:** scope the create tier to POST /v1/tasks only ([64a544c](https://github.com/Xeonice/cloud-agent-platform/commit/64a544caf7a47f5c4a03c879aa511282351e4562))
* **release:** create the attestation out dir before the atomic temp write ([438dc2b](https://github.com/Xeonice/cloud-agent-platform/commit/438dc2b337e5044a81f67a99940bb13e7333ca02))
* **release:** create the attestation out dir before the atomic temp write ([4d6d79e](https://github.com/Xeonice/cloud-agent-platform/commit/4d6d79ea7924365f4298ee826e002edd4d3b87de))
...
* **self-update:** pull pull-only cap images (sandbox stager) on upgrade ([1e6ea96](https://github.com/Xeonice/cloud-agent-platform/commit/1e6ea961b70cd39b63442080c276f6086580afc5))
...
* **settings:** scope api-key/mcp-token/codex/import by account id for local accounts ([11f2e13](https://github.com/Xeonice/cloud-agent-platform/commit/11f2e13b8554872959d234903d3fda22fa3ab82c))
...
* **terminal:** backpressure terminal-record replay so large casts don't discard data ([3e31954](https://github.com/Xeonice/cloud-agent-platform/commit/3e31954fb5277a22e2d72abe80b78e9c73a4ae11))
...
* **terminal:** scroll back the running live terminal (tmux alt-screen off + viewport sync) ([ebcfb03](https://github.com/Xeonice/cloud-agent-platform/commit/ebcfb03e5981c394e95010042b84fd770e27f1c4))
...
* **terminal:** strip alt-screen on snapshot/tail_replay too (v0.20.6 only did onRaw) ([4221e6c](https://github.com/Xeonice/cloud-agent-platform/commit/4221e6cefb04677eb07d5f83ead68b00ab4b44c1))
