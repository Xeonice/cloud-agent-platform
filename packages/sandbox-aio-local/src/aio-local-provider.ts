...
export interface AioLocalSandboxProviderDescriptorOptions<TProvider extends SandboxCapabilitySource> {
  readonly id?: string;
...
export function defineAioLocalSandboxProvider<TProvider extends SandboxCapabilitySource>(
