 ...
 * the shared terminal session so the interactive-vs-headless decision — the riskiest
...
export interface SandboxTerminalLaunchPlan {
...
export function selectLaunch(
  runtime: SandboxTerminalRuntime,
  executionMode: SandboxTerminalExecutionMode,
  ...
  const terminalStartup: SandboxTerminalStartup = headless
